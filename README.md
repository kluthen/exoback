...
| [Internal S2S calls elide request_id — mandatory correlation id is empty on every internal message](issues/ISS-120_20260722_internal_request_id_mandatory.md) | 2026-07-22 | Open | High | Every service-to-service call the hub makes through `upsilonplatform/httpx` c... |
