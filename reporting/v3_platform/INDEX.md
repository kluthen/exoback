...
| [`service_extraction/00_identity_economy_extraction.md`](service_extraction/00_identity_economy_extraction.md) | Identity (→V3-1a) & Economy (post-v3.0) extraction plan along the migration seams. | Not started |
