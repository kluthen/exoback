...
|---|---|---|---|---|
| ISS-126 | [ISS-126_20260804_skills_go_atd_link_cap.md](ISS-126_20260804_skills_go_atd_link_cap.md) | Medium | Open | `gateway/skills.go` carries 12 ATD link occurrences against the 10 cap (6 distinct atoms) and conflates three concerns — template catalogue / skill inventory / roll-progression; split the file (and `skill_test.go`) rather than delete links |
